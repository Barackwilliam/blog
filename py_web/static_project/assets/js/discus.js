function get_discuss_func(event, typ, intgr){
    $(document).ready(function(){
        console.log('func:- ', '.get_discuss_' + typ  + intgr.toString());
     var this_ = $('.get_discuss_' + typ + intgr.toString());
         ...
         success: function(data){
             ...
             if(req_username == post_author_username || req_username == c_username){
                 ...
                 comm_state += "<button type='button' id='main_comment_media_5008" + c_id + "href' data-href='/q/" + c_id + "/main_dis/delete/discussion/' onclick=editable_comment('#main_comment_media_5008" + c_id + "','" + c_id + "','dlt') class='badge badge-dark float-right'>Delete</button>";
                 comm_state += "</div></div></div></div>";
             }
 
     comm_state += "<div class='media col-md-12 m-0 p-0' id='main_comment_media_5008" + c_id + "'><a href='#reply_comment_5008"+ c_id + "'></a><img class='img-fluid rounded-circle mr-2' width='30' height='30' src='" ;
     ...
     comm_state += "<div class='media-body m-0 p-0'><div id='reply_comment_5008" + c_id + "'><small class='p-0 m-0'><a class='c-hover comment-hover-func-" + c_id + "' href='mailto:" + c_username + "' data-href='/account/" + c_username + "/comment_hover_user/' onmouseover='hover_func(" + c_id + ")' data-toggle='tooltip_" + c_id + "' data-html='true' title='" + c_username + "'>";
     ...
     comm_state += " (" + c_date_created + ") "; 
         ...
         comm_state += "</small></small><form id='commbox" + c_id + "main' data-href='/q/" + c_id + "/main_dis/edit/discussion/'><input type='hidden' name='csrfmiddlewaretoken' value='" + token + "'> <small class='p-0 m-0' id='commtext" + c_id + "main'>" + c_text + "</small></form><small id='editabletext" + c_id + "mainbutton' onclick=editable_comment('#commbox','" + c_id + "main','sbmit')></small><small id='canceltext" + c_id + "mainbutton' onclick=editable_comment('#commtext','" + c_id + "main','cancel')></small></div>";
     if(data.user_authenticated){
         comm_state += "<ul class='list-inline pt-0'><li class='list-inline-item'><small class='comment_like_count_" + c_id + "-main text-muted' disabled>" + c_like_count + "</small> <a href='#'><small id='comment_likes_" + c_id + "-main' class='comment_like' onclick=follow_and_comment_like(event,'" + c_id + "-main') data-href='/q/" + c_id + "/like_unlike/main_dis/'>" + c_like_unlike_btn + " </small></a></li>";
         comm_state += "<li class='list-inline-item'><a data-toggle='collapse' href='#collapse" + c_id + "' aria-expanded='false' aria-controls='collapse" + c_id + "'><small id='editable-text-" + c_id + "-reply'><i class='fa fa-share'></i> reply</small></a></li></ul><div class='collapse' id='collapse" + c_id + "' data-parent='#accordian'><div class='card card-body mt-0 pt-0 border-0' >";
         comm_state += "<form id='Public_comment_" + typ + c_id + "' data-href='/q/reply_dis_" + typ + "/discuss_q_and_a/'><input type='hidden' name='csrfmiddlewaretoken' value='" + token + "'> <div class='form-group row'><input type='hidden' name='q_id' value='" + post_id + "'><input type='hidden' name='path' value='" + post_slug_name + "'><input type='hidden' name='reply_to' value='" + c_username + "'><input type='hidden' name='dis_id' value='" + c_id + "'><label class='border-info' for='message'>Type message</label>";
         comm_state += "<textarea class='form-control' name='message' id='main_message_" + c_id + "' rows='5' cols='50' placeholder='reply' required></textarea><button id='Public_comment_submit_btn" + typ + c_id + "main' class='btn btn-sm bg-light shadow' type='submit' name='button' onclick=reply_Public_comment(event,'" + typ + c_id.toString() + "','main'," + intgr.toString() + ") >reply</button></div></form></div></div>";
     }
     else{
         ...
         comm_state += "<div class='media m-0 p-0 reply_comment_media_1008" + cr_id + "' id='reply_comment_1008" + cr_id + "'><a href='#reply_comment_1008" + cr_id + "'></a><img class='img-fluid rounded-circle mr-2' width='30' height='30' src='";
             if(cr_profile_photo){
             ...
             comm_state += "' alt='pt'><div class='media-body'><small class='p-0 m-0'><a class='c-hover comment-hover-func-r" + cr_id + "' href='mailto:" + cr_username + "' data-href='/account/" + cr_username + "/comment_hover_user/' onmouseover=hover_func(" + cr_id + ",'r') data-toggle='tooltip_r" + cr_id + "' data-html='true' title='" + cr_username + "'>";
                     ...
                     comm_state += "</small></small><form id='commbox" + cr_id + "reply' data-href='/q/" + cr_id + "/reply_dis/edit/discussion/'><input type='hidden' name='csrfmiddlewaretoken' value='" + token + "'> <small class='p-0 m-0' id='commtext" + cr_id + "reply'>" + cr_text + "</small></form>";
                 ...
                 if (data.user_authenticated){
                     comm_state += "<ul class='list-inline pt-0'><li class='list-inline-item'><small class='comment_like_count_" + cr_id + "-reply text-muted' disabled>" + cr_like_count + "</small> <a href='#'><small id='comment_likes_" + cr_id + "-reply' class='comment_like' onclick=follow_and_comment_like(event,'" + cr_id + "-reply') data-href='/q/" + cr_id + "/like_unlike/reply_dis/'>" + cr_like_unlike_btn + "</small></a></li>";
                     comm_state += "<li class='list-inline-item'><a class='collapsed' data-toggle='collapse' href='#collapseExample1" + cr_id + "' aria-expanded='false' aria-controls='collapseExample" + cr_id + "'><small><i class='fa fa-share'></i> reply</small></a></li></ul><div class='collapse' id='collapseExample1" + cr_id + "' data-parent='#accordian'><div class='card card-body mt-0 pt-0 border-0' >";
                     
                     comm_state += "<form id='Public_comment_r" + typ + cr_id + "' data-href='/q/reply_dis_" + typ + "/discuss_q_and_a/'><input type='hidden' name='csrfmiddlewaretoken' value='" + token + "'> <div class='form-group row'><input type='hidden' name='q_id' value='" + post_id + "'><input type='hidden' name='dis_id' value='" + c_id + "'><input type='hidden' name='path' value='" + post_slug_name + "'><input type='hidden' name='reply_to' value='"+ cr_username + "'><label class='border-info' for='message'>Type message</label>";
                     comm_state += "<textarea class='form-control' name='message' id='reply_message_" + cr_id + "' rows='5' cols='50' placeholder='reply' required></textarea><button id='Public_comment_submit_btn" + typ + cr_id + "reply' class='btn btn-sm bg-light shadow' type='submit' name='button' onclick=reply_Public_comment(event,'" + typ + cr_id.toString() + "','reply'," + intgr.toString() + ")>reply</button></div></form></div></div>";
                 }
                 else{
         ...
         if (req_username == cr_username || req_username == post_author_username){
             ...
             comm_state += "<button type='button' id='reply_comment_1008" + cr_id + "href' data-href='/" + cr_id + "/reply_dis/delete/discussion/' onclick=editable_comment('#reply_comment_1008" + cr_id + "','" + cr_id + "','dlt') class='badge badge-dark float-right'>Delete</button></div></div></div></div>";
     ...
     comm_state += "<div class='media'><div class='media-body'><ul class='list-inline pt-0'><li class='list-inline-item'><a class='collapsed' data-toggle='collapse' href='#collapseExample2" + typ + intgr.toString() + "' aria-expanded='false' aria-controls='collapseExample2" + typ + intgr.toString() + "'><h6>discuss: <i class='fa fa-comments'></i> </h6></a></li></ul><div class='collapse' id='collapseExample2" + typ + intgr.toString() + "' data-parent='#accordian'><div class='card card-body mt-0 pt-0 border-0' >";
     comm_state += "<form id='Public_comment_" + typ + intgr.toString() + "' data-href='/q/main_dis_" + typ + "/discuss_q_and_a/'><input type='hidden' name='csrfmiddlewaretoken' value='" + token + "'><div class='form-group row'><input type='hidden' name='q_id' value='" + post_id + "'><input type='hidden' name='path' value='" + post_slug_name + "'><label class='border-info' for='message'>Type message</label><textarea class='form-control' name='message' id='main_message_main_comment' rows='8' cols='80' placeholder='reply' required></textarea><button class='btn btn-sm bg-light shadow' id='Public_comment_submit_btn" + typ + intgr.toString() + "main' type='submit' name='button' onclick=reply_Public_comment(event,'" + typ + intgr.toString() + "','main') >Submit</button>";
     comm_state += "</div></form></div></div></div></div>";
 
     $('.accordian_' + typ + intgr.toString()).html("").append(comm_state);
     $('#discussion-heading_' + typ + intgr.toString()).html("All discussion:- ");
     var ts_ = $('.c-hover');
